...
import com.dev.sourav.imagepicker.util.ExifDataCopier
import com.dev.sourav.imagepicker.util.FileUtil
import com.dev.sourav.imagepicker.util.ImageUtil
import java.io.File
...
class CompressionProvider(activity: ImagePickerActivity) : BaseProvider(activity) {
    ...
    init {
        ...
        mMaxFileSize = bundle.getLong(com.dev.sourav.imagepicker.Pikar.EXTRA_IMAGE_MAX_SIZE, 0)
        ...
        object : AsyncTask<Uri, Void, File>() {
            ...
            override fun onPostExecute(file: File?) {
                ...
                if (file != null) {
                    ...
                    // Post Error
                    setError(com.github.sourav.imagepicker.R.string.error_failed_to_compress_image)
                }
            }
        }.execute(uri)
    }
