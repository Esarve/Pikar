...
import com.dev.sourav.imagepicker.provider.CameraProvider
import com.dev.sourav.imagepicker.provider.CompressionProvider
import com.dev.sourav.imagepicker.provider.CropProvider
import com.dev.sourav.imagepicker.provider.GalleryProvider
import com.dev.sourav.imagepicker.util.FileUriUtils
import com.github.sourav.imagepicker.R
...
class ImagePickerActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        internal fun getCancelledIntent(context: Context): Intent {
            ...
            intent.putExtra(com.dev.sourav.imagepicker.Pikar.EXTRA_ERROR, message)
            return intent
        }
    }
    ...
    private fun loadBundle(savedInstanceState: Bundle?) {
        ...
        val provider: ImageProvider? =
            intent?.getSerializableExtra(com.dev.sourav.imagepicker.Pikar.EXTRA_IMAGE_PROVIDER) as ImageProvider?
    ...
    private fun setResult(uri: Uri) {
        val intent = Intent()
        intent.data = uri
        intent.putExtra(com.dev.sourav.imagepicker.Pikar.EXTRA_FILE_PATH, FileUriUtils.getRealPath(this, uri))
    ...
    fun setError(message: String) {
        val intent = Intent()
        intent.putExtra(com.dev.sourav.imagepicker.Pikar.EXTRA_ERROR, message)
        setResult(com.dev.sourav.imagepicker.Pikar.RESULT_ERROR, intent)
        finish()
    }
}
