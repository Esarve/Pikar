package com.dev.sourav.imagepicker.provider
...
import com.dev.sourav.imagepicker.ImagePickerActivity
import com.dev.sourav.imagepicker.util.FileUtil
...
class CropProvider(activity: ImagePickerActivity) : BaseProvider(activity) {
    ...
    init {
        ...
        mMaxWidth = bundle.getInt(com.dev.sourav.imagepicker.Pikar.EXTRA_MAX_WIDTH, 0)
        mMaxHeight = bundle.getInt(com.dev.sourav.imagepicker.Pikar.EXTRA_MAX_HEIGHT, 0)

        // Get Crop Aspect Ratio parameter from Intent
        mCrop = bundle.getBoolean(com.dev.sourav.imagepicker.Pikar.EXTRA_CROP, false)
        mCropAspectX = bundle.getFloat(com.dev.sourav.imagepicker.Pikar.EXTRA_CROP_X, 0f)
        mCropAspectY = bundle.getFloat(com.dev.sourav.imagepicker.Pikar.EXTRA_CROP_Y, 0f)

        // Get File Directory
        val fileDir = bundle.getString(com.dev.sourav.imagepicker.Pikar.EXTRA_SAVE_DIRECTORY)
