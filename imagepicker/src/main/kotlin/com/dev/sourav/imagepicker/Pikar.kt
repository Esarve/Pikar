package com.dev.sourav.imagepicker

import android.app.Activity
import android.content.Intent
import android.os.Bundle
import androidx.fragment.app.Fragment
import com.dev.sourav.imagepicker.constant.ImageProvider
import com.dev.sourav.imagepicker.listener.DismissListener
import com.dev.sourav.imagepicker.listener.ResultListener
import com.dev.sourav.imagepicker.util.DialogHelper
import java.io.File
...
open class Pikar {
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun with(activity: Activity): com.dev.sourav.imagepicker.Pikar.Builder {
            return com.dev.sourav.imagepicker.Pikar.Builder(activity)
        }
         ...
         */
        @JvmStatic
        fun with(fragment: Fragment): com.dev.sourav.imagepicker.Pikar.Builder {
            return com.dev.sourav.imagepicker.Pikar.Builder(fragment)
        }
        ...
        fun getError(data: Intent?): String {
            val error = data?.getStringExtra(com.dev.sourav.imagepicker.Pikar.Companion.EXTRA_ERROR)
            if (error != null) {
                return error
            } else {
    ...
    class Builder(private val activity: Activity) {
         ...
         */
        fun provider(imageProvider: ImageProvider): com.dev.sourav.imagepicker.Pikar.Builder {
        ...
        fun cameraOnly(): com.dev.sourav.imagepicker.Pikar.Builder {
        ...
        fun galleryOnly(): com.dev.sourav.imagepicker.Pikar.Builder {
         ...
         * @param mimeTypes
         */
        fun galleryMimeTypes(mimeTypes: Array<String>): com.dev.sourav.imagepicker.Pikar.Builder {
         ...
         */
        fun crop(x: Float, y: Float): com.dev.sourav.imagepicker.Pikar.Builder {
            cropX = x
            cropY = y
            return crop()
        }
         ...
         */
        fun crop(): com.dev.sourav.imagepicker.Pikar.Builder {
            this.crop = true
            return this
        }
         ...
         *
         */
        fun cropSquare(): com.dev.sourav.imagepicker.Pikar.Builder {
            return crop(1f, 1f)
        }
         ...
         */
        fun maxResultSize(width: Int, height: Int): com.dev.sourav.imagepicker.Pikar.Builder {
            this.maxWidth = width
         ...
         */
        fun compress(maxSize: Int): com.dev.sourav.imagepicker.Pikar.Builder {
         ...
         */
        fun saveDir(path: String): com.dev.sourav.imagepicker.Pikar.Builder {
            this.saveDir = path
            return this
        }
         ...
         */
        fun saveDir(file: File): com.dev.sourav.imagepicker.Pikar.Builder {
         ...
         */
        fun setImageProviderInterceptor(interceptor: (ImageProvider) -> Unit): com.dev.sourav.imagepicker.Pikar.Builder {
         ...
         */
        fun setDismissListener(listener: DismissListener): com.dev.sourav.imagepicker.Pikar.Builder {
         ...
         * Sets the callback that will be called when the dialog is dismissed for any reason.
         */
        fun setDismissListener(listener: (() -> Unit)): com.dev.sourav.imagepicker.Pikar.Builder {
         ...
         */
        fun start() {
            start(com.dev.sourav.imagepicker.Pikar.Companion.REQUEST_CODE)
        }
        ...
        private fun createIntent(): Intent {
            val intent = Intent(activity, com.dev.sourav.imagepicker.ImagePickerActivity::class.java)
        ...
        private fun getBundle(): Bundle {
            return Bundle().apply {
                putSerializable(com.dev.sourav.imagepicker.Pikar.Companion.EXTRA_IMAGE_PROVIDER, imageProvider)
                putStringArray(com.dev.sourav.imagepicker.Pikar.Companion.EXTRA_MIME_TYPES, mimeTypes)

                putBoolean(com.dev.sourav.imagepicker.Pikar.Companion.EXTRA_CROP, crop)
                putFloat(com.dev.sourav.imagepicker.Pikar.Companion.EXTRA_CROP_X, cropX)
                putFloat(com.dev.sourav.imagepicker.Pikar.Companion.EXTRA_CROP_Y, cropY)

                putInt(com.dev.sourav.imagepicker.Pikar.Companion.EXTRA_MAX_WIDTH, maxWidth)
                putInt(com.dev.sourav.imagepicker.Pikar.Companion.EXTRA_MAX_HEIGHT, maxHeight)

                putLong(com.dev.sourav.imagepicker.Pikar.Companion.EXTRA_IMAGE_MAX_SIZE, maxSize)

                putString(com.dev.sourav.imagepicker.Pikar.Companion.EXTRA_SAVE_DIRECTORY, saveDir)
            }
        }
